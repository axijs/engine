...
[@axi-engine/data](../README.md) / CoreBooleanFieldOptions

# Interface: CoreBooleanFieldOptions

Defined in: packages/data/src/fields/field-definitions/core-boolean-field.ts:4

Configuration options for creating a new Field instance.

## Extends

- [`FieldOptions`](FieldOptions.md)\<`boolean`\>
