...
Defined in: packages/data/src/fields/field-definitions/core-field.ts:15
...
Defined in: packages/data/src/fields/field-definitions/core-field.ts:63
...
> `protected` `readonly` **\_onChange**: `Emitter`\<\{ `oldValue`: `T`; `value`: `T`; \}\>
...
> `readonly` **onChange**: `Subscribable`\<\{ `oldValue`: `T`; `value`: `T`; \}\>
...
Defined in: packages/data/src/fields/field-definitions/core-field.ts:18
